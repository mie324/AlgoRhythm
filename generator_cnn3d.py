...
if __name__ == "__main__":
    ...
    for epoch in epoch_nums:
        ...
        for n_notes in n_notes_list:
            ...
            convert_array_to_midi_CNN_3D(notes.squeeze(0), rests.squeeze(0), lengths.squeeze(0), "./generated_midi/generated_cnn3d_{}_epochs_{}_notes_new.mid".format(epoch, n_notes), tempo=90)
